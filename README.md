## 👋 Hi, I'm Erivelton Menezes

🎓 **Legal background | Transitioning into Technology & Cybersecurity**

I’m a professional with a **legal foundation** and a growing focus on **software development**, **cybersecurity**, and **digital law**.  
My goal is to connect legal reasoning with technological innovation to create more secure, ethical, and efficient digital solutions.


## 🧠 Core Competencies
- **Programming:** Python (automation, data analysis, scripting)  
- **Cybersecurity:** Network defense, risk management, digital forensics (in training)  
- **LegalTech & Compliance:** GDPR, LGPD, data governance  
...
- 👉 📊**IBM** [Data Science Professional Certificate](https://www.credly.com/badges/38a50ade-f48b-476b-b658-491dd21f718e/public_url)*
-
- *(in progress)*  
